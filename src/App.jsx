...
// Sample projects — replace with your real repos
const projects = [
  {
...
function Hero() {
  return (
    <div className="relative h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black overflow-hidden snap-start">
      ...
      >
        <h1 className="text-5xl font-extrabold text-white mb-4">Hey, I’m Sachin.</h1>
        ...
        <div className="flex justify-center space-x-6">
          <a
            ...
            className="px-6 py-3 border-2 border-cyan-500 text-cyan-400 rounded-lg font-medium hover:bg-cyan-500 hover:text-black transition"
          >
            LinkedIn
          </a>
          <a
...
function About() {
  return (
    <section id="about" className="h-screen flex items-center justify-center bg-gray-900 text-gray-300 snap-start">
      <motion.div
...
function Projects() {
  return (
    <section id="projects" className="h-screen flex items-center justify-center bg-black text-gray-200 snap-start">
      <div className="max-w-4xl px-6 grid gap-8 md:grid-cols-2">
        {projects.map((proj, i) => (
          ...
          >
            ...
            <span className="text-cyan-400 font-medium hover:underline">View on GitHub →</span>
          </motion.a>
        ))}
      </div>
    </section>
...
function Contact() {
  return (
    <section id="contact" className="h-screen flex items-center justify-center bg-gray-900 text-gray-300 snap-start">
      <motion.div
