...
const Home = () => (
  <motion.div className="min-h-screen flex flex-col items-center justify-center text-center p-6 pt-24"
    ...
    <div className="text-5xl font-extrabold mb-4 text-blue-800 dark:text-blue-400">
      <Typewriter
        textStyle={{ fontFamily: 'Red Hat Display', color: '#3f3d56', fontWeight: 700, fontSize: '2.5rem' }}
        startDelay={100}
        cursorColor="#3f3d56"
        multiText={["Hi, I'm Sachin Yoganandham", "Data Analyst", "Dashboard Enthusiast"]}
        multiTextDelay={1500}
        typeSpeed={80}
      />
    </div>
