...
const ToggleDarkMode = () => {
  ...
  return (
    <button
      onClick={toggle}
      className="fixed bottom-4 right-4 p-2 bg-gray-800 text-white rounded-full shadow"
    >
      🌓
    </button>
  );
...
const Home = () => (
  <motion.div
    className="min-h-screen flex flex-col items-center justify-center text-center p-6 pt-24"
    initial="hidden"
    animate="visible"
    variants={fadeIn}
  >
    ...
    <a
      href="#projects"
      className="mt-8 px-6 py-3 bg-blue-600 text-white rounded-full animate-bounce hover:bg-blue-700 transition"
    >
      View Projects
    </a>
  </motion.div>
...
const About = () => (
  <motion.div
    className="p-6 max-w-3xl mx-auto pt-28"
    initial="hidden"
    whileInView="visible"
    variants={fadeIn}
  >
    ...
    <p className="text-lg text-gray-700 dark:text-gray-300">
      Hi, I’m Sachin Yoganandham — a data analyst turning complex data into
      meaningful insights. I specialize in SQL, Python, Power BI and automation
...
const Projects = () => (
  <motion.div
    id="projects"
    className="p-6 max-w-4xl mx-auto pt-28"
    initial="hidden"
    whileInView="visible"
    variants={fadeIn}
  >
    ...
    <div className="grid gap-6 md:grid-cols-2">
      {[
        ...
        <motion.div
          key={i}
          className="p-4 border rounded shadow dark:border-gray-700"
...
const Blog = () => (
  ...
  >
    ...
    <p>
      🚧 Posts coming soon! I'll share thoughts on data strategy, tools, and
      career growth.
    </p>
  </motion.div>
);
...
const Contact = () => (
  ...
  >
    ...
    <ul className="list-disc list-inside text-blue-600 dark:text-blue-400">
      ...
      <li>
        <a href="mailto:sachin@sachiny.me">Email Me</a>
      </li>
    </ul>
  </motion.div>
);
